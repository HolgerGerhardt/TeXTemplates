...
\makeatletter
\renewcommand{\bfseries@tt}{b}%
\let\savettmdseries\mdseries@tt
\let\savettbfseries\bfseries@tt
\let \textbforig \textbf
\renewcommand{\textbf}[1]{{%
	\textbforig{%
		\renewcommand{\bfseries@tt}{\savettbfseries}%
		\renewcommand{\bfseries@rm}{\savebfdefaultfortext}%
			% For some reason, LaTeX resets these series to semibold instead of bold.
		#1%
	}%
}}
\makeatother
...
\else
	...
	\renewcommand{\mddefault}{\savemddefaultfortext}
	\renewcommand{\bfdefault}{\savebfdefaultfortext}
\fi
...
\setbeamertemplate{frametitle}{%
	...
	{\large\usebeamercolor{frametitle}\textbf{\usebeamerfont{frametitle}\insertframetitle}\\[-1.2ex]}%
	\sliderule%
}
% <==
...
\BeforeBeginEnvironment{frame}{%
	...
	\setbeamertemplate{footline}{\vskip-15pt%
		...
		\textmd{\usebeamerfont{structure}\insertshortauthor: \enquote{\insertshorttitle}}
		\hfill%
		\textbf{\usebeamerfont{structure}\insertframenumber/\inserttotalframenumber}%
		\hspace{\marginright}%
		\vspace{12pt}%
	}%
	% <==
	...
	\addtobeamertemplate{block begin}{%
		...
		\begin{mdframed}[linecolor=\framedblockcolor, linewidth=0.35pt, leftmargin=0pt, innerleftmargin=0.375em, innerrightmargin=0.375em, innertopmargin=-0.01ex, innerbottommargin=4pt]%
			...
			\renewcommand{\insertblocktitle}{%
				...
				\textbf{\usebeamerfont{structure}\insertblocktitleorig}\strut\vspace{-1.5pt}%
