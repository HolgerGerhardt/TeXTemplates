...
\newcommand{\manuscriptdate}{2025-11-01}  % In ISO format: yyyy-mm-dd
...
\begin{tcolorbox}[before upper = {\setlength{\parindent}{0pt}\setlength{\parskip}{\medskipamount}\strut}]
	...
	\quad
	{\relscale{1.05}\fontfamily{FiraSans-TLF}\selectfont Fira Sans: {\itshape a\,\textalpha}, {\itshape p\,\textrho}, {\itshape u\,\textupsilon}, {\itshape v\,\textnu}, {\itshape y\,\textgamma}, {\itshape Y\,\textUpsilon}}
\end{tcolorbox}
...
\newcommand{\Kafka}{%
	...
	08/15 \textKappa\'{\textalpha}\textphi\textkappa\textalpha
	\par%
}
