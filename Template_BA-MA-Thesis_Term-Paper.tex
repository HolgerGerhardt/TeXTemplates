...
\beware{%
	...
	%\bfseries Compilation via \url{https://uni-bonn.sciebo.de/apps/overleaf_nextcloud/launcher/launch} should work, too. \\[\medskipamount]
...
\iffalse
	% Use \iffalse to suppress the text font samples, needed for https://uni-bonn.sciebo.de/apps/overleaf_nextcloud/launcher/launch
