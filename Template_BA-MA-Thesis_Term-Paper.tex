...
\newcommand{\manuscriptdate}{2026-06-19}  % In ISO format: yyyy-mm-dd
\newcommand{\manuscripttype}{TP}  % BA for bachelor's thesis, MA for master's thesis, otherwise term paper
