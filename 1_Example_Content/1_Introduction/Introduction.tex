...
Let us cite \replaced[id=HG]{a~couple of}{some} publications \citep{Andersen2008, Andreoni2012, Balakrishnan2016, Bursztyn2025, Lisi1995}. With the options set for BibLaTeX in the preamble, citations in the body text are \deleted[id=LV]{automatically }sorted chronologically---irrespective of the order of the ``citekeys'' in your input. In the list of references, entries are sorted alphabetically by author surname.\added[id=UR]{ Let's cite} \cite{Andersen2008} once more.
