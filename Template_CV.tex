...
\sectionfont{\large\sffamily\bfseries\color{SpotColor}}
...
\ifxetex
	...
	\newcommand{\sansseriffont}{MetaPro}
	\setsansfont{\sansseriffont-Norm}[
		Numbers={Proportional, OldStyle},
		ItalicFont = {\sansseriffont-NormIta},
		BoldFont = {\sansseriffont-Bold},
		BoldItalicFont = {\sansseriffont-BoldIta},
		Scale=0.95
	]
	\topiclabelfont{\small\sffamily\addfontfeature{BoldFont = {\sansseriffont-Medi}}}
\else
	\usepackage[book, semibold, lining, tabular, scale=0.93]{FiraSans}
	\usepackage[charter, greeklowercase=italicized, greekuppercase=italicized, sfscaled=false, ttscaled=false]{mathdesign}
	\topiclabelfont{\small\sffamily\renewcommand{\bfseries}{\fontseries{medium}\selectfont}}
\fi
...
Lab Manager, Laboratory for Experimental Economics---BonnEconLab \\[\medskipamount]
...
\begin{topic}
	...
	Lecture ``Economics and Psychology'' (joint with Frederik Schwerter), 2015/16, M.Sc. level.
	
	Lecture {\selectlanguage{ngerman}``Experimentelle Wirtschaftsforschung''} (in German, ``Experimental Economics,'' joint with Sebastian Kube), 2014, B.Sc. level.
	...
	Exercise classes to the lecture ``Growth and Inequality in an International Perspective,'' M.Sc. level, 2008, 2009.
	...
	Exercise classes to the lecture {\selectlanguage{ngerman}``Konjunktur- und Wachstumspolitik/\hspace{0pt}Angewandte Makroökonomie''} (in German, ``Business Cycle and Growth Policy/\hspace{0pt}Applied Macroeconomics''), B.Sc. level, 2006, 2006/07, 2007/08.
