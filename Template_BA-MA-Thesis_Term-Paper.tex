...
\newcommand{\studentfullname}{\AE nn\i\ Sn\^{e}\v{z}{\`a}\~{n}\'{a} H\r{a}land-\c{C}a{\l}han\H{o}\u{g}l\"{u}}
...
\newcommand{\manuscriptdate}{2026-06-20}  % In ISO format: yyyy-mm-dd
\newcommand{\manuscripttype}{BA}  % BA for bachelor's thesis, MA for master's thesis, otherwise term paper
\newcommand{\manuscriptlanguage}{DE}  % DE for German, otherwise (US) English
...
{\selectlanguage{USenglish}\beware{%
	...
	\bfseries Compilation via \url{https://overleaf-en.astro.uni-bonn.de} is also supported. \mdseries Use ``Shibboleth login'' to log in with your Uni~\caps{ID}. \par \medskip
	\bfseries And compilation via \url{https://uni-bonn.sciebo.de/apps/overleaf_nextcloud/launcher/launch} should work, too. \mdseries Compiling the entire document from scratch may lead to a~time-out. Compiling the document again (and again) usually works. So does compiling a~shortened version. \par \medskip
