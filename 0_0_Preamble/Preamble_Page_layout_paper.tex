...
\newcommand{\appendixformat}[1][\currentname]{%
	\titleformat{\section}[hang]%
		{}{\Large\textsf{\textbf{\appendixname~\thesection\quad}}}{0pt}{%
			\raggedright\Large\textsf{\textbf{#1}}%
		}[]%
}
\AtBeginEnvironment{appendices}{\appendixformat}

\titleformat{name=\section}[hang]%
	{}{\Large\textsf{\textbf{\thesection\quad}}}{0pt}{%
		\raggedright\Large\textsf{\textbf{#1}}%
	}[]
...
\titleformat{name=\subsection}[hang]%
	{}{\textscale{1.125}{\textsf{\textbf{\thesubsection\quad}}}}{0pt}{%
		\raggedright\textscale{1.125}{\textsf{\textbf{#1}}}%
	}[]
