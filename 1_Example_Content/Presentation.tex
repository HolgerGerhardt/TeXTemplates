...
\NewTblrColumnType{U}{S[table-format={**}+1.3{-**}, round-mode=places, round-precision=3, round-integer-to-decimal=false]}%
...
\SetTblrInner[booktabs]{
	...
	row{Z} = {cmd = \discard, ht = 0pt, abovesep = -10pt, belowsep = -10pt},
}
