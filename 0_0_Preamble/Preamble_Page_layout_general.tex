...
\usepackage[bottom, multiple, norule, splitrule]{footmisc}
% \renewcommand{\multfootsep}{,\,}
% AER-like style: no regular footnote rule, half-page splitrule
% ==>
% Right-aligned footnote number in a box as wide as the body indentation
\AtBeginDocument{%
	\setlength{\footnotemargin}{\newparindent}%
	\renewcommand{\footnotelayout}{\setlength{\parindent}{\newparindent}}% Indentation of paragraphs within footnote
}
% Right-aligned non-superscript footnote number in box as wide as 3 digits, followed by period
\makeatletter
\let \@makefntextorig \@makefntext
\newcommand{\@makefntextcustom}[1]{%
	\setlength{\parindent}{\newparindent}% Indentation of paragraphs within footnote
	\noindent%
	\makebox[\widthof{000}][r]{% Reserve space for 3 digits
		\normalfont\@thefnmark%
	}.\:\,#1%
}
...
\g@addto@macro\@floatboxreset{\sffamily\small}  % Use small sans-serif font by default in figures and tables
\makeatother
...
%\SetTblrStyle{caption-tag}{font = \sffamily\bfseries\small}
%\SetTblrStyle{caption-sep}{font = \sffamily\bfseries\small}
%\SetTblrStyle{caption-text}{font = \sffamily\small}
...
\SetTblrStyle{remark}{halign = j, hang = 0pt, indent = 0pt, font = \footnotesize}

% Global defaults for the siunitx package, version 2
...
%}
% Global defaults for the siunitx package, version 3.4.14 (2025-07-09)
\sisetup{
	%detect-all,
	mode = match,
...
\NewTblrColumnType{T}[2][]{S[table-format = {{***}#2{***}}, #1]}
