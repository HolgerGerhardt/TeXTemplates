...
\newcommand{\studentfullname}{\AE nn\i\ Lu\"{i}\.{z}a Sn\^{e}\v{z}{\`a}\~{n}\'{a} H\r{a}land-\c{C}a{\l}han\H{o}\u{g}l\"{u}}
...
\newcommand{\manuscriptdate}{2026-07-12}  % In ISO format: yyyy-mm-dd
