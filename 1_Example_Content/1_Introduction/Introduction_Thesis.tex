...
Let us cite \replaced[id=LV]{a~few}{some} publications: \cite{Andersen2008, Andreoni2012, Balakrishnan2016, Lisi1995}.%
\comment[id=UR]{Check whether there are more recent publications!}
With the options set for BibLaTeX in the preamble, citations in the body text are \added[id=LV]{automatically} sorted chronologically---irrespective of the order of the ``citekeys'' in your input. In the list of references, entries are sorted alphabetically by surname. \cite{Andersen2008} once more.
