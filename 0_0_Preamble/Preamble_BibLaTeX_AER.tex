...
\usepackage[backend=biber, natbib=true, bibencoding=inputenc, bibstyle=authoryear, citestyle=authoryear-comp, mincitenames=1, maxcitenames=3, minbibnames=99, maxbibnames=99, uniquename=false, uniquelist=false, backref=true, backrefstyle=three, doi=true, isbn=false, dashed=false, sorting=ynt, sortcites=true, mergedate=true, dateabbrev=false, abbreviate=false]{biblatex}
...
\renewcommand{\bibfont}{\sffamily\small} % Reduce font size for the bibliography, make the font sans-serif
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% FREDDIE'S ADDTIONAL CITE COMMANDS  %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\newcommand{\cposs}   [1]{\citeauthor{#1}'s \citeyearpar{#1}}
\newcommand{\citeposs}[1]{\cposs{#1}}
\newcommand{\caposs}  [1]{\citeauthor{#1}'s}
\newcommand{\citeian} [1]{\citeauthor{#1}ian \citeyearpar{#1}}
\newcommand{\ian}     [1]{\citeauthor{#1}ian}
\newcommand{\citeians}[2]{\citeauthor{#1}ian (\citeyear{#1}, \citeyear{#2})}
\newcommand{\cit}     [1]{\citeauthor{#1}, \citeyear{#1}}
\newcommand{\cits}    [2]{\citeauthor{#1}, \citeyear{#1}, \citeauthor{#2}, \citeyear{#2}}