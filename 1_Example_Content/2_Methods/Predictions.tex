...
Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages.\footnote{Really long footnote.\blindmathfalse\blindtext[1]\par\blindtext[2]\par\blindtext[4]\blindmathtrue} Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages. Let's include a~really, really long footnote to check how it is split across two pages.
...
This environment can be used to state your hypotheses and set them apart from the body text.
\end{hypothesis}
