...
{\parindent 0pt
Default: $a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma$; $\sigma_\epsilon, c^\alpha$

mathnormal: $\mathnormal{a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathrm: $\mathrm{a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathup: $\mathup{a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathit: $\mathit{a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathbf: $\mathbf{a \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathbfit: $\mathbfit{a \alpha b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathbfup: $\mathbfup{a \alpha b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$
...
mathbf: $\mathbf{a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathbfit: $\mathbfit{a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$

mathbfup: $\mathbfup{a \alpha \alphaup b \beta G \Gamma \upGamma P \Pi \Sigma \sigma}$
}
...
$\lim_{n \to \infty} \psi(n) = \max_{s \in S} \{s \pm 3 \gamma + y - 1\} = 4 \times 7$
