...
\AtBeginDocument{%
	\renewcommand{\texteuro}{{\fontencoding{TS1}\selectfont\char"BF}}%
}
...
\input{0_0_Preamble/Preamble_Fonts_IBMPlex}
...
\ifnum \serifbodyfont=0
	...
	\AtBeginDocument{\fontseries{\savesfmdseries}\sffamily}
\else
	\usefonttheme{serif}
	\setbeamerfont{normal text}{family=\rmfamily}
	\renewcommand{\familydefault}{\savermfamily}
	\renewcommand{\mddefault}{\savermmdseries}
	\renewcommand{\bfdefault}{\savermbfseries}
	\AtBeginDocument{\fontseries{\savermmdseries}\rmfamily}
\fi
\ifnum \serifheadingfont=0
	\setbeamerfont{structure}{family=\sffamily, shape=\upshape, series=\fontseries{\savesfbfseries}}
\else
	\setbeamerfont{structure}{family=\rmfamily, shape=\upshape, series=\fontseries{\savermbfseries}}
\fi
...
\ifnum \serifheadingfont=0
	\setbeamerfont{footline}
		{parent=structure, size=\tiny, series=\fontseries{\savesfmdseries}}
\else
	\setbeamerfont{footline}
...
\input{0_0_Preamble/Preamble_Sansserif_math_IBMPlex}
...
\ifnum \serifheadingfont=0
	\setbeamerfont{subtitle}
		{parent=structure, size=\Large, series=\fontseries{\savesfmdseries}}
\else
	\setbeamerfont{subtitle}
...
\AtBeginEnvironment{table}{\vspace{-1.2ex}\small}  % Reduce font size in and excessive white space above tables
\renewcommand{\lTblrDefaultHruleColorTl}{SpotColor}
...
% Global defaults for the siunitx package
\sisetup{
	detect-all,
	mode = match,
