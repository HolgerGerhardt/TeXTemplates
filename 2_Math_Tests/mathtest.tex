...
{\parindent 0pt
Default: $a \alpha b \beta G \Gamma P \Pi \Sigma$

mathnormal: $\mathnormal{a \alpha b \beta G \Gamma P \Pi \Sigma}$

mathrm: $\mathrm{a \alpha \alphaup b \beta G \Gamma P \Pi \Sigma}$

mathup: $\mathup{a \alpha \alphaup b \beta G \Gamma P \Pi \Sigma}$

mathit: $\mathit{a \alpha b \beta G \Gamma P \Pi \Sigma}$

mathbf: $\mathbf{a \alphaup b \beta G \Gamma P \Pi \Sigma}$

mathbfit: $\mathbfit{a \alpha b \beta G \Gamma P \Pi \Sigma}$

mathbfup: $\mathbfup{a \alpha b \beta G \Gamma P \Pi \Sigma}$
...
mathrm: $\mathrm{a \alpha b \beta G \Gamma P \Pi \Sigma}$

mathup: $\mathup{a \alpha b \beta G \Gamma P \Pi \Sigma}$

mathit: $\mathit{a \alpha b \beta G \Gamma P \Pi \Sigma}$

mathbf: $\mathbf{a \alpha b \beta G \Gamma P \Pi \Sigma}$
