...
\begin{alertblock}{%
	...
	\begin{minipage}[b]{3\colwidth+2\colsep-145pt}
		...
		{\mdseries These screenshots are taken from \cite{Dertwinkel-Kalt2017}.\; \textit{Balanced:} Both payoffs concentrated on single date (\balA, \balB).\; \textit{Unbalanced:} Later (\unbalA) or earlier payoff (\unbalB) dispersed over $n$~dates.}
	\end{minipage}
}
