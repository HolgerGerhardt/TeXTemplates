...
\usepackage[book, semibold, lining, tabular, scale=0.88]{FiraSans}[2018/05/23]
	% The book and semibold options currently (2019-05-25) do not work
	% in comination with the siunitx package!
%\usepackage[lining, tabular, scale=0.88]{FiraSans}[2018/05/23]
\makeatletter
