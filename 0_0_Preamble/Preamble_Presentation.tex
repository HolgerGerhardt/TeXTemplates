...
\setbeamerfont{footline}{parent=structure, size=\tiny, series=\mdseries}
\setbeamercolor{footline}{fg=SpotColor}
...
\fi
\setlength{\belowcaptionskip}{0.25ex}  % Remove excessive vertical space between table titles and tables
