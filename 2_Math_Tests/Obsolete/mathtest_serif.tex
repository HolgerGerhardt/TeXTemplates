...
\newcommand{\mathalphabets}{%
	\begin{tabular}{@{} p{0.2\textwidth} l @{}}
		Default:    & $a \alpha \alphaup b \beta G \Gamma P \Pi \alpha \beta$ \\
		...
		mathbf:     & $\mathbf{a \alpha \alphaup b \beta G \Gamma P \Pi}$ \\
...
\noindent
{\sffamily\selectfont $\alpha a > 0, \beta b + (3 \times 27), \Gamma G = 7 < 8, \lambda$}
