...
\newcommand{\termpapertitle}{%
	Eine Vorlage f{\"u}r eine Hausarbeit \\
	in einem beliebigen Studiengang%
}
\newcommand{\seminartitle}   {Theoretische und empirische Mikro{\"o}konomik und \\
                              Makro{\"o}konomik mit Implikationen f{\"u}r die Sozialpolitik \\
                              {\"u}berall auf der Welt}
\newcommand{\studentfullname}{Lou~I. Vu{\"i}-T{\o}n}
\newcommand{\studentemail}   {lou-i.vui-ton@example.org}
\newcommand{\studentID}      {7654321}
\newcommand{\advisorname}    {Prof.~Dr. Vae-Ree Smart}
\newcommand{\advisorgender}  {m}  % f for female, m for male
\newcommand{\submittedon}    {\datengerman\today}
...
\date{\today}
\include{0_1_Frontmatter_Thesis_Term_Paper/Term_Paper_frontmatter_DE}
