...
\newcommand{\thesisauthor}{I.~M.~B{\'e}ta Zane-{\AA}l}
...
\author{\thesisauthor}
\date{\today}
%\include{0_1_Frontmatter_Thesis_BA_MA/Thesis_frontmatter_DE}
\include{0_1_Frontmatter_Thesis_BA_MA/Thesis_frontmatter_EN}
