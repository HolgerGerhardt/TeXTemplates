...
% ==>
\usepackage[
	charter, greeklowercase = italicized, greekuppercase = italicized,
	sfscaled = false, ttscaled = false, euro = false
]{mathdesign}
...
% ==>
\usepackage[scaled = 0.96, lining]{XCharter}  % option ``sups'' not working properly with subimport
% Save the font family and font series definitions for later use:
...
%\AtBeginDocument{%
%	\renewcommand{\@makefnmark}{\sustyle\@makefnmarkorig}%
%}
\makeatother
% <==
