...
\AtBeginDocument{%
	...
	\setlength{\parindent}{\newparindent}
	\setlength{\lineskiplimit}{0pt}  % Prevents increased line spacing in response to spacious inline formulas.
}
...
\renewenvironment{quote}%
  {\list{}{\leftmargin=\parindent \rightmargin=\parindent}\item[]\itshape\small}%
  {\endlist}
\renewenvironment{quotation}%
  {\list{}{\leftmargin=\parindent \rightmargin=\parindent}\item[]\small}%
  {\endlist}
% <==
