...
\newcommand{\changesfontsettings}{\sffamily\scriptsize\setlength{\baselineskip}{2.25ex}}
\renewcommand{\todoformat}[1]{{\changesfontsettings\strut#1\par}}
...
\renewcommand{\todo}[2][]{%
	\todoorig[
		color = Changes@Color, bordercolor = Changes@Color, #1, tickmarkheight = 0.1cm, linecolor = authorcolor
	]{\strut#2}%
}
\makeatother
