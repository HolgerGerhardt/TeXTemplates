...
\titleformat{name=\section, numberless}[hang]  % For the starred version
...
\titleformat{name=\subsection, numberless}[hang]  % For the starred version
	{\raggedright\large\sffamily\bfseries}{}{0pt}{%
		\xcapitalisewords{#1}%
	}[]
\titleformat{name=\subsubsection}[runin]%
	{}{}{0pt}{%
		\textsf{\textbf{\thesubsubsection\quad%
			\xcapitalisewords{#1}\iftextterm{#1}{}{\unskip.}%
		}}%
	}[]
\titleformat{name=\subsubsection, numberless}[runin]  % For the starred version
	{}{}{0pt}{%
		\textsf{\textbf{%
			\xcapitalisewords{#1}\iftextterm{#1}{}{\unskip.}%
		}}%
...
%		\xcapitalisewords{#1}%
%	}[]
%\titleformat{name=\subsubsection, numberless}[hang]  % For the starred version
...
\newenvironment{abstract}{%
	...
	\begingroup%
	\noindent%
	\sffamily\fontseries{sl}\selectfont%
	\textbf{\fontseries{sb}\selectfont Abstract.}~\space%
	\ignorespaces%
}{%
	\unskip\par
	\endgroup
