...
\newpagestyle{bullshitheader}[\small\rmfamily\selectfont]{
	...
	{% odd-center
		\phantom{\textsf{\texteuro $\mathit{x} \mathbfit{X}$}}%
		% We include a \textsf plus math commands, because for some weird reason,
...
\titlecontents{chapter}
	[1.5em]
	{\addvspace{1ex}}
	{\sffamily\bfseries\contentslabel{1.5em}}{\hspace*{-1.5em}\sffamily\bfseries}  % The latter ``outdents'' unnumbered sections; bold and sans-serif chapter entries in ToC
	{\sffamily\bfseries\titlerule*{}\contentspage[\thecontentspage\hspace{-.12em}]}
\titlecontents{section}
	[3.8em] % = 1.5em + 2.3em, 1.5em reserved for chapter numbering
	{\addvspace{0.25ex}}
	{\contentslabel{2.3em}}{\hspace*{-2.3em}}  % The latter ``outdents'' unnumbered sections
	{\tocdots\contentspage}
...
\newcommand{\TestForPunct}[1]{\iftextterm{#1}{#1}{#1.}}
...
\newcommand{\appendixformat}[1][\currentname]{%
	...
	{\raggedright\Large\sffamily\bfseries}{Appendix~\thesection\quad}{0pt}{%
		\ecapitalisewords{%
			#1%
		}%
	}[]
