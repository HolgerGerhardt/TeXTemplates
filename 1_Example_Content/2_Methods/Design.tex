...
Yet slightly different is the approach put forth by Academic Writing \caps{UK}:\footnote{See \url{https://academic-englishuk.com/paragraphing/}.}\par\nopagebreak
\begin{enumerate}
...
Let us illustrate the ``\caps{MEAL}''\slash``\caps{PEEL}'' structure---including an optional explanation or definition---using example sentences from \citet{sigfridsson}:
...
$\sigma_\epsilon, c^\alpha$.
\blindtext
Let's test the footnote settings.\footnote{\blindmathfalse\unskip\blindtext\blindmathtrue}
