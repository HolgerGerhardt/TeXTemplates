...
Normative model: exponential discounting. However, observed decisions are hard to explain \citep[e.g.,][]{Dohmen2012}.
\begin{itemize}
	\item The composition of latex and of typical rubbers is given below. Math test: ${\mathbfit{\chi} \in \{\bm{X}, \bm{Y}\}}$, $\sigma_\epsilon$, $c^\alpha$.
	...
	\item Separation of resin from solid caoutchouc is possible.
	\item But it is not practicable or profitable commercially.
\end{itemize}
\end{parblock}
